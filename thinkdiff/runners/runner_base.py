...
class RunnerBase:
    ...
    @property
    def amp_dtype(self):
        amp_dtype = self.config.run_cfg.get("amp_dtype", "float16")
    ...
    @property
    def use_clip_grad_norm(self):
        use_clip_grad_norm = self.config.run_cfg.get("use_clip_grad_norm", False)
        return use_clip_grad_norm
    
    @property
    def max_grad_norm(self):
        max_grad_norm = self.config.run_cfg.get("max_grad_norm", 1.0)
